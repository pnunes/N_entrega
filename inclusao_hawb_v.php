...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/inclusao_hawb_vertical.css">
       ...
       $(function(){
			$('#cliente').change(function(){
				if( $(this).val() ) {
					$('#servico').hide();
					$('.carregando').show();
					$.getJSON('procura_servico.php?search=',{cod_cli: $(this).val(), ajax: 'true'}, function(j){
					...
					$('#servico').html('<option value="">– Escolha Subcategoria –</option>');
				}
			});
		});
...
<body>
	...
	switch (get_post_action('fixa_cabe','gravar')) {
		case 'fixa_cabe':
			 ...
			 $_SESSION['codi_servi_m'] = $_POST['servico'];
		break;
		...
		case 'gravar':
		      ...
		      if($cod_barra <> '') {
				  ...
				  numero_desti,comple_desti,bairro_desti,classe_cep,cep_desti,cidade_desti,estado_desti,data_previ_entrega';
				  
				  $conteudo_post = "'".$_POST['escritorio']."'".","."'".$v_data_movi."'".","."'".$_POST['cliente']."'".","."'".$_SESSION['codi_servi_m']."'".","."'".
				  $_POST['cod_barra']."'".","."'".$_POST['nu_hawb']."'".","."'".'BIP-1'."'".","."'".$qtdade."'".","."'".$_POST['vr_servico']."'".","."'".
				  $_POST['cd_destino']."'".","."'".$_POST['no_destino']."'".","."'".$_POST['cnpj_destino']."'".","."'".$_POST['rua']."'".","."'".
				  $_POST['numero']."'".","."'".$_POST['complemento']."'".","."'".$_POST['bairro']."'".","."'".$_POST['cl_cep']."'".","."'".
				  $_POST['cep_destino']."'".","."'".$_POST['cidade']."'".","."'".$_POST['estado']."'".","."'".$v_data_preve."'";
				  ...
				  if($grava_desti == 'S') {
					 ...
					 comple_desti,bairro_desti,classe_cep,cep_desti,cidade_desti,estado_desti,dt_atu_cada'; 
					 ...
					 if($inserir == '2I') {
					  ...
					  "dt_atu_cada="."'".$v_data_movi."'".","."cep_desti="."'".$_POST['cep_destino']."'";
	...
	//Verifica se houve preenchimento do campo HWB para dessecar o numero da hawb e chamar outros dados
	if(isset($_POST['cod_barra'])){
		...
		if($cod_barra <>''){
			...
			If ($achou > 0 ) {
			   ?>
			   <script language="javascript"> window.location.href=("inclusao_hawb.php")
			   ...
			   <?php
				...
				if(strlen($cod_barra) == 26){
				   ...
				   $qtdade = 1;
					...
					?>
					<script language="javascript"> window.location.href=("inclusao_hawb.php")
					  alert('Código de barra esta fora do padrão (26 caravteres)! verifique.');
					</script>
					<?php
				}
			}
		...
		<div id="principal">
			<div class="form-group" id="g_fixo">
				<div class="form-group">
					...
					<div class="col-md-7" id="data_prev">
						...
						<div class="input-group date">
								<input type="text" class="form-control" id="data_pren" value="<?php echo $data_movi;?>" name="data_pren">
								<div class="input-group-addon">
									<span class="glyphicon glyphicon-th"></span>
								</div>
						</div>
			...
			<div class="form-group" id="cab_fixo">
				<div class="col-md-2" id="fixa_cabecalho">
					<button type="Submit" id="fixa_cabe" name="fixa_cabe" class="btn btn-primary">Fixa Cabeçalho Remessa</button>
				</div>
			</div>			
            <div class="form-group">
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-13">
				    <a href="entrada.php"><button id="voltar" name="voltar" class="btn btn-primary" type="button">Voltar</button></a>
					<div id="mensagem" style="width:300px;height:25px;float:left;position:relative;margin-left:120px;margin-top:-3px;text-align:center;">
			            <font face="arial" size="3" color="#ffffff"><?php echo "$resp_grava";?></font>
			        </div>
					<button id="gravar" name="gravar" class="btn btn-primary" type="Submit">Gravar</button>
				</div>
				<div id="result"></div>
			</div>
		</div>
