	...
	switch (get_post_action('pega_hawb')) {
		...
		case 'pega_hawb': 
			 ...
			 if($n_hawb <>''){
				...
				DATE_FORMAT(dt_dev_origem,'%d/%m/%Y'),lote_devo_origem,observacao,imagem_exportada				
	  ...
	  if($nu_hawb <>''){
		...
		If ($total_d > 0 ) {
		   ...
		   $_SESSION['controle_m'] = $controle;
			...
			?>
		   <script language="javascript"> window.location.href=("consulta_hawb.php")
			  alert('HAWB Não registrada No Sistema! Verifique.');
		   </script>
		   <?php 
				...
				<div class="input-group" id="c_entregador">
					...
					<div class="col-md-13">
						<select id="entregador" name="entregador" class="form-control">
							<?php
							$sqlf = "SELECT cnpj_cpf,nome FROM pessoa";
			...
			<div class="input-group" id="dados_baixa">
				...
				<div id="dt_lista_devo">
					<div class="input-group">
						...
						<span class="input-group-addon">Data Lista </span>
						<div class="input-group date">
							<input type="text" class="form-control" id="data_lista_dev" value="<?php echo $dt_lista_dev;?>" name="data_lista_dev">
							<div class="input-group-addon">
								<span class="glyphicon glyphicon-th"></span>
							</div>
						</div>
                ...
                <div id="dt_devo_origem">
					<div class="input-group">
						...
						<div class="input-group date">
							<input type="text" class="form-control" id="data_dev_orige" value="<?php echo $dt_dev_orige;?>" name="data_dev_orige">
							<div class="input-group-addon">
								<span class="glyphicon glyphicon-th"></span>
							</div>
						</div>
