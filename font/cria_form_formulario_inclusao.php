<?php
    //Pega na tabela ESTRUTURA_TABELA os campos da tabela que devem compor o formulario
    ...
    if($total_campos > 0) {
		for($ii=0; $ii<$total_campos; $ii++){
				...
				<div class="form-group">
					<div class="col-sm-10">
						<div class="input-group date">
							<input type="text" class="form-control" id="<?php echo $nome_campo;?>" name="<?php echo $nome_campo;?>">
			...
			if($tipo_campo == 'blob' or $tipo_campo == 'mediumtext'){	
				?>
				<tr>
					<td><b><?php echo $etiqueta;?></b></td>
					<td>
						<textarea class="form-control" id="<?php echo $nome_campo;?>" name="<?php echo $nome_campo;?>" rows="3" cols="60"></textarea>
					</td>
				</tr>
				<?php
			}
			if($tipo_campo == 'longblob'){	
				...
				<tr>
					<td><b><?php echo $etiqueta;?></b></td>
					<td>
						<textarea class="form-control" id="<?php echo $nome_campo;?>" name="<?php echo $nome_campo;?>" rows="6" cols="60"></textarea>
					</td>
				</tr>
				<?php
			}
			if($tipo_campo == 'char' or $tipo_campo == 'varchar') {
				if($liga_tab<>'') {
					...
					?>
						<tr>
							<td><b><?php echo $etiqueta;?></b></td>
							<td><input type="<?php echo $tipo_campo;?>" name="<?php echo $nome_campo;?>" size="<?php echo $tama_campo;?>" maxlength="<?php echo $tama_campo;?>" id="<?php echo $nome_campo;?>" class="campo"></td>
						</tr>
					<?php
				}
			}
