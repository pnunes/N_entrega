				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						    <li><a href="tela_entra_cadastro.php?tabela=pessoa&qtdc=4&titulo=Atualização Cadastro Pessoas&cab_1=CPF/CNPJ&cab_2=NOME&cab_3=TIPO&cab_4=CATEGO&codigo_sql=SQL_PES&modulo=CADASTROS&titulo_doc=&estilo=2&sentido=&volta=tela_entra_cadastro.php">Pessoa</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=destino&qtdc=4&titulo=Atualização Cadastro Destinos&cab_1=CODIGO&cab_2=NOME&cab_3=CIDADE&cab_4=ESTADO&codigo_sql=SQL_DES&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=2&volta=tela_entra_cadastro.php">Destinos</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=escritorio&qtdc=4&titulo=Atualização Cadastro Filiais&cab_1=CODIGO&cab_2=NOME&cab_3=SIGLA&cab_4=ESTADO&codigo_sql=SQL_ESC&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=2&volta=tela_entra_cadastro.php">Filiais</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=servico&qtdc=2&titulo=Atualização Cadastro Serviços&cab_1=CODIGO&cab_2=DESCRIÇÃO&cab_3=&cab_4=&codigo_sql=SQL_SER&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=1&volta=tela_entra_cadastro.php">Serviços</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=tabela_preco&qtdc=4&titulo=Atualização Tabela Preços&cab_1=CODIGO&cab_2=SERVIÇO&cab_3=CLASSE SERVICO&cab_4=CLIENTE&codigo_sql=SQL_TAP&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=2&volta=tela_entra_cadastro.php">Tabela de Preço</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=ocorrencia&qtdc=2&titulo=Atualização Cadastro Ocorrências&cab_1=CODIGO&cab_2=DESCRIÇÃO&cab_3=&cab_4=&codigo_sql=SQL_OCO&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=1&volta=tela_entra_cadastro.php">Ocorrências</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="tela_entra_cadastro.php?tabela=intervalo_cep&qtdc=2&titulo=Atualização Cadastro Classe CEP&cab_1=CODIGO&cab_2=NOME CLASSE&cab_3=UF&cab_4=CIDADE&codigo_sql=SQL_CCP&modulo=CADASTROS&imprime=N&titulo_doc=&estilo=2&volta=tela_entra_cadastro.php">Classe CEP</a></li>
						</ul>
					</li>
					<li class="dropdown">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="atualiza_permissoes_usuario.php?modulo=CONFIGURAÇÕES">Permissões</a></li>
							<li role="separator" class="divider"></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="#">Rotinas Sistema</b></a></li>
							<li role="separator" class="divider"></li>
